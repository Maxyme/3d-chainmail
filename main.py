...
get_cube = Cube()   #creates the cube : get_cube.side=side value get_cube.step = step value
                    #get_cube.matrix = matrix of data
get_force = Force(get_cube)   #creates the force : get_force.x=x displacement (same for y and z)
                              #get_force.posx = (original x position on top
                                                         #surface) (same for y)
